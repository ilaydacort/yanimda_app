...
**Yanımda** — Acil Yardım & Güvenlik Kişisi Bildirim Uygulaması
...
> *(Ekran görüntülerini buraya ekleyebilirsin. GitHub'a resim yükleyip `![açıklama](resim.png)` formatında eklemen yeterli.)*
